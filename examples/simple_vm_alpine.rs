...
/// Example of creating a simple VM with Alpine Linux
///
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let disk_path = image_dir.join("alpine-cloud.raw");
    ...
    if !fw_path.exists() || !disk_path.exists() {
        ...
        eprintln!("  - examples/images/alpine-cloud.raw");
    ...
    println!("Starting Cloud Hypervisor VM with Alpine Linux...");
