# Rust API client for cloud-hypervisor-sdk
...
Put the package under your project folder in a directory named `cloud-hypervisor-sdk` and add the following to `Cargo.toml` under `[dependencies]`:

```
cloud-hypervisor-sdk = { path = "./cloud-hypervisor-sdk" }
```
...
*DefaultApi* | [**vm_resize_disk_put**](docs/DefaultApi.md#vm_resize_disk_put) | **PUT** /vm.resize-disk | Resize a disk
